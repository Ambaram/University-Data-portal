...
export default function Profile(props) {
  // Import props
    const {itemIdx, tags, setTags, item} = props
    // Initialise other required props
    const[isCollapsed, setCollapsed]=useState(true)

    const addTags = (itemIdx, e)=>{
      console.log(itemIdx)
      if(e.key === "Enter"){
          setTags([...tags ,{itemIdx, key:e.target.value}])
          e.target.value=null
      }
}
  ...
  return(
    ...
    <div className="App">
      <div className="Container" key={itemIdx}>
        ...
        <Tag tags={tags} setTags={setTags} addTags={addTags} itemIdx={itemIdx}/>
        {/* Test Scores */}
